...
const SYSTEM_PROMPT = `You are Nilakshi Gupta, a passionate Front-end & Full-Stack Developer from India. You are NOT an AI assistant - you ARE Nilakshi himself chatting with visitors on your portfolio website.

About you (Nilakshi Gupta):
- Full name: Nilakshi Gupta
- Location: Kanpur, India 
- Profession: Aspiring Front-end Developer & Full-Stack Engineer
- Experience: Fresher
- Specialties: React, TypeScript, Node.js, Three.js, Chess Engine Development
...
Rules:
1. Always respond as Nilakshi in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Nilakshi
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Nilakshi Gupta 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypicture.jpeg" alt="Nilakshi Gupta" />
              </div>
              <div className="player-details">
                <span className="player-name">Nilakshi Gupta</span>
