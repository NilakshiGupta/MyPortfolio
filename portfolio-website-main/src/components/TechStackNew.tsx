...
// Perfect inverted pyramid: 13 -> 10 -> 8 -> 6 -> 4 -> 2
const techStack: TechItem[][] = [
  // Row 1 - 13 items (largest)
  [
    { name: "Python", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", url: "https://python.org" },
    { name: "Java", icon: "https://img.icons8.com/?size=100&id=13679&format=png&color=000000", url: "https://java.com" },
    { name: "Spring Boot", icon: "https://img.icons8.com/?size=100&id=A3Ulk2RcONKs&format=png&color=000000", url: "https://spring.io/projects/spring-boot" },
    { name: "Hibernate/JPA", icon: "https://img.icons8.com/?size=100&id=819rVzhtJ5Dh&format=png&color=000000", url: "https://en.cppreference.com/w/cpp" },
  ...
  [
    ...
    { name: "JWT", icon: "https://img.icons8.com/?size=100&id=rHpveptSuwDz&format=png&color=000000", url: "https://JWT.com" },
    ...
    { name: "Rest API", icon: "https://img.icons8.com/?size=100&id=6kPR2dlup5KK&format=png&color=000000", url: "https://restapi.org" },
    { name: "OpenCV", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/opencv/opencv-original.svg", url: "https://opencv.org" },
    { name: "Vite", icon: "https://img.icons8.com/?size=100&id=dJjTWMogzFzg&format=png&color=000000", url: "https://vitejs.dev" },
